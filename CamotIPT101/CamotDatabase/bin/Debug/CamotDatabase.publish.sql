...
GO
:setvar DatabaseName "Camot"
:setvar DefaultFilePrefix "Camot"
...
GO
PRINT N'Creating Table [dbo].[Flower Shop]...';


GO
CREATE TABLE [dbo].[Flower Shop] (
...
GO
PRINT N'Creating Procedure [dbo].[CreateFlower]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[DeleteFlower]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetAllFlower]...';


GO
CREATE PROCEDURE [dbo].[GetAllFlower]
	
AS
BEGIN
	SELECT * FROM [dbo].[Flower Shop]
END
GO
PRINT N'Creating Procedure [dbo].[UpdateMotor]...';
